...
// Feature: Integrations with Medidata Rave (EDC), Veeva Vault (CTMS), and Epic/Cerner (EHR)
import React, { useState } from 'react';
import api from '../services/api';

export default function IntegrationsWithMedidataRaveEdcVeevaVaultCtPage() {
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb', maxWidth: 980 }}>
      <h2 style={{ marginTop: 0 }}>Integrations with Medidata Rave (EDC), Veeva Vault (CTMS), and Epic/Cerner (EHR)</h2>
      <p style={{ color: '#9ca3af', fontSize: 13 }}>
        Endpoint: <code>/api/cf-integrations-with-medidata-rave-edc-veeva-vault-ct/run</code>. Submit context as text; the backend calls OpenRouter and returns structured JSON.
      </p>
      <textarea
        value={input}
