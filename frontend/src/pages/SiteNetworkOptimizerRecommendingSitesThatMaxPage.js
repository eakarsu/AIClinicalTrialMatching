...
// Feature: Site network optimizer recommending sites that maximize recruitment speed and diversity
import React, { useState } from 'react';
import api from '../services/api';

export default function SiteNetworkOptimizerRecommendingSitesThatMaxPage() {
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb', maxWidth: 980 }}>
      <h2 style={{ marginTop: 0 }}>Site network optimizer recommending sites that maximize recruitment speed and diversity</h2>
      <p style={{ color: '#9ca3af', fontSize: 13 }}>
        Endpoint: <code>/api/cf-site-network-optimizer-recommending-sites-that-max/run</code>. Submit context as text; the backend calls OpenRouter and returns structured JSON.
      </p>
      <textarea
        value={input}
