...
export default function TrialsPage() {
  ...
  useEffect(() => { loadData(); }, []);
  const loadData = async () => { try { const res = await api.get('/trials'); setItems(res.data); } catch(e){} setLoading(false); };
      ...
      <div>
        ...
        {aiResult && (
          <div className="ai-output">
            <div className="ai-output-header"><span className="ai-badge">AI ANALYSIS</span><span className="model-info">Model: {aiResult.model || 'Claude Haiku'}</span></div>
